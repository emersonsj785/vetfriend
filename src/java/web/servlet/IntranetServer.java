...
public class IntranetServer extends HttpServlet {
            ...
            if (accion != null) {
                switch (accion) {
                    ...
                    case "actualizar":
                        ...
                        break;
                    case "listar":
                        result = validator.usuariosSel();
                        break;
                    case "DEL":
                        result = validator.usuariosDel();
                        target = "CarClientes.jsp";
                        break;
                    default:
